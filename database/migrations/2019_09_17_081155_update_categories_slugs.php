...
class UpdateCategoriesSlugs extends Migration
{
	private $eng = [
		...
		"cat1_2" => ['name' => "Estate & Wine Cellar", 'slug' => "estate-wine-cellar"],
		...
		"cat3" => ['name' => "Caterer", 'slug' => "catering"],
		...
		"cat4" => ['name' => "Wine lovers", 'slug' => "wine-lovers"],
		"cat4_1" => ['name' => "Wine Tasting", 'slug' => "wine-tasting"],
		"cat4_2" => ['name' => "Activities", 'slug' => "activities"],
		"cat4_3" => ['name' => "Shop & Winebar", 'slug' => "shop"],
		"cat4_4" => ['name' => "Guide", 'slug' => "guide"],
		"cat5" => ['name' => "Equipment/Decoration", 'slug' => "equipment"],
		...
		"cat6" => ['name' => "Entertainment", 'slug' => "entertainment"],
