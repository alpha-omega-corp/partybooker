...
<?php $component->withAttributes([]); ?>
                <?php echo e(__('partner.trial_ending', [
...
<?php endif; ?>
        ...
        <?php if($user->subscription('PartyBooker')->onGracePeriod()): ?>
            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashboard.card-info','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('dashboard.card-info'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e(__('form.subscription_access_ending', [
...
<?php /**PATH /home/nanstis/PhpstormProjects/pb-live/resources/views/components/dashboard/header.blade.php ENDPATH**/ ?>