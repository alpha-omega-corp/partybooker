<div id="new-faq" class="popup">
    <div class="popup_form">
        <form method="POST" action="<?php echo e(url(App\Http\Middleware\LocaleMiddleware::getLocale() . '/cp/faq/add-new-faq')); ?>">
            <?php echo e(csrf_field()); ?>

            <div class="close">X</div>
            <h4><?php echo e(__('partybooker-cp.new_faq')); ?></h4>
...
<?php /**PATH /home/nanstis/PhpstormProjects/pb-live/resources/views/admin/popups/new-faq.blade.php ENDPATH**/ ?>