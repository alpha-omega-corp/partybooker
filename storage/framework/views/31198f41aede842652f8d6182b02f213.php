            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-uppercase" aria-current="page">
                        <a
                            href="<?php echo e(url(App\Http\Middleware\LocaleMiddleware::getLocale() . '/' . __('urls.listings'))); ?>"><?php echo e(__('service.listings')); ?></a>
                    </li>
                    <li class="breadcrumb-item
                                text-uppercase" aria-current="page">
                        <a
                            href="<?php echo e(url(App\Http\Middleware\LocaleMiddleware::getLocale() . '/' . __('urls.listings') . '/' . $current->parent->lang->slug)); ?>">
                            <?php echo e($current->parent->lang->name); ?>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nanstis/PhpstormProjects/pb-live/resources/views/web/listings/sub-category.blade.php ENDPATH**/ ?>