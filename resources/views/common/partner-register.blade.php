        ...
        <form action="{{ url(App\Http\Middleware\LocaleMiddleware::getLocale() . '/partner/reg') }}"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title text-uppercase fw-bold text-primary" id="partnership">
                ...
                <div class="modal-body">
                    <div class="container-fluid row g-3">
                        ...
                        <label class="d-flex bg-primary logoUpload justify-content-center align-items-center"
                        ...
                        <div class="input-group">
                            <span
                                class="input-group-text align-items-start text-uppercase bg-premium text-white fw-bold">
