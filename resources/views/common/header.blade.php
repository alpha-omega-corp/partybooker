    ...
    <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
            <div class="links">
                ...
                <a page="listing" href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/' . __('urls.listings'))}}">{{__('main.listing_page')}}</a>
                <a page="partner" href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/' . __('urls.partner'))}}">{{__('main.become_partner_page')}}</a>
                <a page="aboutus" href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/' .  __('urls.aboutus'))}}">{{__('main.aboutus_page')}}</a>
