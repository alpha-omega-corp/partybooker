...
<div id="page">
	<div class="container">
		...
		<div class="row qab">
			<div class="col-md-4">
				<a href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/cp/add-new-partner')}}" class="button">{{ __('partybooker-cp.add_new_partner')}}</a>
			</div>
			<div class="col-md-4">
		...
		<div class="row">
			...
			<div class="col-md-6 events">
				...
				@foreach ($notifications as $key=>$notification)
					...
					@endif
						<div class="col-md-12"><strong>{{$notification->event_date}}</strong></div>
						<div class="col-md-5">{{$notification->event}}</div>
						<div class="col-md-7">{{$notification->description}}</div>
					</div>
				@endforeach
			</div>
		</div>
