    ...
    <div id="page" class="post">
        <div class="container">
            <form method="POST" id="post"
                  action="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/cp/blog/create-post')}}"
                    ...
                    <div class="col-md-6 col-lg-7">
                        ...
                        <div class="terms-en lang-tab" lan="en">
                            <input type="text" name="title_en" class="post-title"
                                   placeholder="{{ __('partybooker-cp.post_title')}}" required/>
                        ...
                        <div class="terms-fr lang-tab" lan="fr">
                            <input type="text" name="title_fr" class="post-title"
                                   placeholder="{{ __('partybooker-cp.post_title')}}" required for="post_fr"/>
