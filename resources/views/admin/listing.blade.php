                    ...
                    <div class="service-block" num="{{$key+1}}" data-name="{{$service->en_company_name}}"
                        ...
                        <div class="row">
                            <div class="offset-md-1 col-md-10">
                                <div class="row">
                                    ...
                                    <a href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/cp/partner-cp/'.$service->id_partner)}}/advert"
                                       class="button">{{ __('partybooker-cp.view_profile')}}</a>
                                    <a href="#" id="remove-partner" data-partner="{{$service->id_partner}}"
                                       class="button btn-remove">{{ __('partybooker-cp.remove_partner')}}</a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <p><span>{{ __('partybooker-cp.payment_exp_date')}}</span> {{$service->expiration_date}}
                                </p>
                            </div>
                        </div>
                    </div>
