            ...
            <form method="POST"
                    ...
                    <div class="col-md-12">
                        ...
                        <span class="checkbox-item">
                            <input type="checkbox" name="languages[]"
                                   {{ isset($languages['english']) ? 'checked' : '' }}
                                   value="english">
                        ...
                        <span class="checkbox-item">
                            <input type="checkbox" name="languages[]"
                                   {{ isset($languages['italian']) ? 'checked' : '' }}
                                   value="italian">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea value="{{ old('en_seo_desc') }}" name="en_seo_desc"
                                  placeholder="En SEO description"></textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea value="{{ old('fr_seo_desc') }}" name="fr_seo_desc"
                                  placeholder="Fr SEO description"></textarea>
                    </div>
                    <div class="col-md-6">
