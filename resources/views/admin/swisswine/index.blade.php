...
<div id="page">
	<div class="container card-block">
		...
		<div class="row">
			<div class="col-12">
				<a href="#" class="btn button" data-toggle="modal" data-target="#create-modal">Add new directory</a>
			</div>
		</div>
		<br>
		<div class="row">
			...
			<div class="card col-lg-3 col-md-4 col-sm-6">
				<div class="card-body">
					...
					<a href="#" id="edit-button" data-id="{{$item->id}}" class="btn button" data-toggle="modal" data-target="#modal-edit">Edit</a>
				</div>
				<a href="{{$item->url}}" target="_blank">
					<img src="{{asset('storage/swisswine_directories/'.$item->image)}}" class="card-img-top">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form-edit" method="post" action="/cp/swisswin/update" enctype="multipart/form-data">
					...
					<img id="image" src="{{asset('storage/swisswin_directories/')}}">
	...
	$('a#edit-button').on('click', function() {
		...
		$.ajax({
			...
			success: function(data) {
				...
				form.find('img#image').attr('src', '{{asset('storage/swisswine_directories')}}/' + data.image);
			},
			error: function(r) {
