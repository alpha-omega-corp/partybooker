...
@section('content')
    <section class="about">
        <div class="container">
            ...
            <img src="{{Vite::image('logoPB.png')}}" class="about-logo"
            ...
            <h2 class="text-uppercase fw-bold display-6">{{__('about.partner_benefits')}}</h2>
            ...
            <section class="team-section">
                ...
                <div class="team mt-5">
                    <div class="row">
                        <div class="col d-flex justify-content-center">
                            <img src="{{Vite::image('Caro_photo_2019.jpeg')}}" class="rounded-circle cover shadow-lg"
