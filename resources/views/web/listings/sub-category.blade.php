		...
		<div class="container p-relative">
			...
			<nav aria-label="">
				<ol class="breadcrumb" style="color: #fe8a02; background: transparent">
					...
					@else
						@if($current->parent)
							<li class="breadcrumb-item" aria-current="page">
								<a href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale() . '/' . __('urls.listings'))}}">{{__('service.listings')}}</a>
							</li>
							<li class="breadcrumb-item" aria-current="page">
								<a href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale() . '/' . __('urls.listings') . '/' . $current->parent->lang->slug )}}">{{$current->parent->lang->name}}</a>
							</li>
							<li class="breadcrumb-item active" aria-current="page">
			...
			<div class="row justify-content-center">
				<div class="col-lg-3 col-sm-6 filters">
					...
					@include('web.common.category-filter', ['listType' => 'sub-category'])
