<div class="edit-category popup popup-form">
	@if (Auth::user()->type == 'admin')
		<form class="login" action="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/cp/partner-cp/edit-category')}}" method="POST">
	@else
		<form class="login" action="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/partner-cp/edit-category')}}" method="POST">
	@endif
		@csrf
		<div class="close"></div>
		<div class="form">
