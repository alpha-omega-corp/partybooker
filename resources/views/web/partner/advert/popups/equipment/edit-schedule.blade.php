<x-dashboard.modal
    id="editEquipmentSchedule{{$iterator}}"
    ...
    <div class="row">
        <div class="col-sm-6">
            <input type="text" name="open" class="time" value="{{$advert->service->opening}}"
                   required/>
        </div>
        <div class="col-sm-6">
            <input type="text" name="close" class="time" value="{{$advert->service->closing}}"
                   required/>
        </div>
    </div>
