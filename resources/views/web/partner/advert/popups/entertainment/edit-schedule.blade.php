<x-dashboard.modal
    id="editEntertainmentSchedule{{$iterator}}"
    ...
    <label class="mt-10">{{__('partner.duration')}}<span>*</span></label>
    <input type="text" name="duration" value="{{$advert->service->duration}}" required/>
