			...
			<div class="col-md-4 col-xl-3">
				<ul class="partner-nav">
					@if(\Auth::user()->type == 'admin')
						...
						<li><a href="{{url(\App\Http\Middleware\LocaleMiddleware::getLocale().'/cp/partner-cp/'.$user->id_partner)}}/plans" class="active">{{__('partner.my_plan')}}</a></li>
					@else
						...
						<li><a href="{{url(\App\Http\Middleware\LocaleMiddleware::getLocale().'/partner-cp/'.$user->id_partner)}}/plans" class="active">{{__('partner.my_plan')}}</a></li>
