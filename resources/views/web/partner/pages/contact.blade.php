				...
				<ul class="partner-nav">
					<ul class="partner-nav">
						...
						@else
							...
							<li><a href="{{url(\App\Http\Middleware\LocaleMiddleware::getLocale().'/partner-cp/'.$user->id_partner)}}/contacts" class="active">{{__('partner.contacts')}}</a></li>
						@endif
					</ul>
				</ul>
