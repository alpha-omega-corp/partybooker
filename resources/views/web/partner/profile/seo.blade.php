<ul class="seo">
	...
	<li class="li"><span>EN Description:</span> {{trim(strip_tags($user->partnerInfo->en_seo_desc ?? $user->partnerInfo->en_full_descr))}}</li>
	<li class="li"><span>FR Description</span> {{trim(strip_tags($user->partnerInfo->fr_seo_desc ?? $user->partnerInfo->fr_full_descr))}}</li>
