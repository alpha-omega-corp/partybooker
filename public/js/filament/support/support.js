...
`, "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
            ...
            var t = Wa(),
                ...
                r = "tippy-box", i = "tippy-service", o = "tippy-backdrop", s = "tippy-arrow", c = "tippy-svg-arrow",
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "))
            ...
            function lt(f, h) {
                ...
                ut(M && _, ["tippy() was passed an Element as the `service` prop, but more than", "one tippy instance was created by this invocation. This means the", "service element will only be appended to the last tippy instance.", `

`, "Instead, pass the .innerHTML of the element, or use a function that", "returns a cloned version of the element instead.", `

`, `1) content: element.innerHTML
`, "2) service: () => element.cloneNode(true)"].join(" "));
